...
train_features_res, train_targets_res = rus.fit_resample(train_features, train_targets)
...
#Best parameters: {'subsample': 0.6, 'reg_lambda': 0.01, 'reg_alpha': 0.01, 'num_leaves': 32, 'n_estimators': 1000, 'min_child_weight': 1, 'max_depth': 6, 'learning_rate': 0.01, 'colsample_bytree': 0.6}
#Best score: 0.7036
